...
import { SessionModalComponent } from './components/modals/session-modal/session-modal.component';
...
import { SquareMoreComponent } from './components/more/square-more/square-more.component';
import { RfuMoreComponent } from './components/more/rfu-more/rfu-more.component';
...
//  declarations: [_pages, TranslatePipe, ChatModelComponent, BannerMoreComponent, PortraitMoreComponent, SquareBannerComponent],
  declarations: [_pages, TranslatePipe, ChatModelComponent, BannerMoreComponent, PortraitMoreComponent, SquareMoreComponent, RfuMoreComponent],
  imports: _imports,
